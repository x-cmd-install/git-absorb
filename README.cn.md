...
![git-absorb](https://repo.x-cmd.io/git-absorb.svg?lang=zh)
...
合计: **2,984** 行代码（覆盖前 5 种语言、共 **12** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 2,690 | 214 | 393 | 8 |
| AsciiDoc | 196 | 0 | 62 | 1 |
| Sh | 50 | 22 | 15 | 1 |
| Toml | 37 | 0 | 7 | 1 |
| Makefile | 11 | 0 | 4 | 1 |
...
- **上游仓库**: <https://github.com/tummychow/git-absorb>
- **官网**: <https://crates.io/crates/git-absorb>
- **许可证**: BSD-3-Clause

## 发布

- **最新版本**: `0.9.0` (2026-02-14)
- **最近提交**: 2026-02-14
- **Release 含资产**: 7 个

## 流行度

- **Star**: 5,719 · **Fork**: 110 · **开放 issue**: 115 · **贡献者**: 42

## 累计统计

- **发布数**: 22 · **已合并 PR**: 88 · **开放 PR**: 2 · **已关闭 issue**: 89 · **开放 issue**: 26 · **提交数**: 378
...
| 360d | 2025-09-18 | 1 | 3 | 2 | 2 | 7 | 4 |
| last720d | 2024-09-23 | 5 | 38 | 2 | 37 | 12 | 127 |
...
在 [repology.org](https://repology.org/project/git-absorb) 上共有 **103** 个发行版报告此项目。**46** 个 ✅ 已是最新上游版本，**48** 个 ⚠️ 使用旧版本。
...
git-absorb 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `git-absorb` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/git-absorb.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260913.yml` · 2026-09-13T04:20:26Z._
